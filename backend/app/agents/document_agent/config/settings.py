...
class DocumentAgentSettings(BaseSettings):
    ...
    llm_max_tokens: int = Field(default=4000, description="Maximum tokens", env="LLM_MAX_TOKENS")
    llm_timeout: int = Field(default=60, description="LLM timeout", env="LLM_TIMEOUT")
